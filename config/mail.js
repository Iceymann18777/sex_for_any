...
const AFTER_REGISTRATION = function(n){
	return {
ru: `<div id="afterRegistration"><h3>Поздравляем!</h3><p>У вас на счету ${promo_token} токенов! Это около ${(promo_token/2)*one_token_btc} биткоинов.</p>Возможно Вам стоит заполнить анкету-профайл для того, чтобы быстрей найти  новых друзей-единомышлеников.<p></p></div>`,
en: `<div id="afterRegistration"><h3>Congratulations!</h3><p>You have on your account ${promo_token} tokens! It's about ${(promo_token/2)*one_token_btc} BTC.</p><p>Please fill out your profile in order easier to find new friends.</p></div>`
		}
	}
